...
@section('content')
    ...
    <form method="POST" action="{{ route('consignaciones.update', $consignacion) }}" enctype="multipart/form-data" style="padding:0.5rem 1.25rem 2rem;" x-data="{ preview: null }">
        @csrf
        @method('PUT')
        ...
        <div class="field-dark">
            ...
            <select id="persona_id" name="persona_id" class="input-dark" required>
        ...
        <div class="field-dark">
            ...
            <input
                ...
                class="input-dark"
                value="{{ old('valor_consignado', $consignacion->valor_consignado) }}"
                placeholder="$ 0.00"
                step="0.01"
                required
            >
