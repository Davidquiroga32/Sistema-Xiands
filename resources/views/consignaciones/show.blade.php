    ...
    <div style="padding:1.5rem 1.25rem;">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.6rem;margin-bottom:1rem;">
            ...
            <div class="card-dark" style="padding:0.85rem 0.9rem;">
                ...
                <div style="font-size:0.9rem;color:{{ $consignacion->interes_aplicado ? '#7ab87a' : 'var(--silver-dark)' }};font-weight:500;">
                    {{ $consignacion->interes_aplicado ? '$ ' . number_format($consignacion->interes_aplicado, 0, ',', '.') : 'No aplicado' }}
                </div>
            </div>
            <div class="card-dark" style="padding:0.85rem 0.9rem;">
                ...
                <div style="font-size:0.9rem;color:var(--silver-bright);font-weight:500;">
                    {{ $consignacion->total_con_interes ? '$ ' . number_format($consignacion->total_con_interes, 0, ',', '.') : '$ ' . number_format($consignacion->valor_consignado, 0, ',', '.') }}
                </div>
            </div>
