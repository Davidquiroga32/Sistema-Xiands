...
@section('content')
    <div style="padding:0.85rem 1.25rem;">
        <a href="{{ route('personas.show', $persona) }}" class="icon-btn" style="display:inline-flex;text-decoration:none;">
            &#8592;
        </a>
    </div>

    <form method="POST" action="{{ route('personas.update', $persona) }}" style="padding:0.5rem 1.25rem 2rem;">
        @csrf
        @method('PUT')
        ...
        <div class="field-dark">
            ...
            <input
                ...
                class="input-dark"
                value="{{ old('correo_electronico', $persona->correo_electronico) }}"
        ...
        <div class="field-dark">
            ...
            <input
                ...
                class="input-dark"
                value="{{ old('numero_telefono', $persona->numero_telefono) }}"
        ...
        <div class="field-dark">
            ...
            <input
                ...
                class="input-dark"
                value="{{ old('nombre_codeudor', $persona->nombre_codeudor) }}"
