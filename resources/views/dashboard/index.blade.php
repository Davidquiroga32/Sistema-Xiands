...
@section('content')
    <div style="padding:1.2rem 1.25rem;">
        <p style="font-size:0.8rem;color:var(--silver-dark);letter-spacing:0.08em;">
            Bienvenido, <span style="color:var(--silver-light);font-weight:600;">{{ Auth::user()->name }}</span>
        </p>
    </div>

    <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.6rem;padding:0 1.25rem 0.8rem;">
        <div class="card-dark" style="padding:1rem 0.9rem;text-align:center;">
            <div style="font-family:'Outfit',sans-serif;font-size:1.3rem;font-weight:700;" class="gradient-text">{{ $totalPersonas }}</div>
            <div style="font-size:0.6rem;color:var(--silver-dark);letter-spacing:0.08em;text-transform:uppercase;margin-top:0.15rem;">Personas</div>
        </div>
        <div class="card-dark" style="padding:1rem 0.9rem;text-align:center;">
            <div style="font-family:'Outfit',sans-serif;font-size:1.3rem;font-weight:700;" class="gradient-text">{{ $totalConsignaciones }}</div>
            <div style="font-size:0.6rem;color:var(--silver-dark);letter-spacing:0.08em;text-transform:uppercase;margin-top:0.15rem;">Consignaciones</div>
        </div>
        <div class="card-dark" style="padding:1rem 0.9rem;text-align:center;">
            <div style="font-family:'Outfit',sans-serif;font-size:1.3rem;font-weight:700;" class="gradient-text">{{ '$ ' . number_format($totalConsignado, 0, ',', '.') }}</div>
            <div style="font-size:0.6rem;color:var(--silver-dark);letter-spacing:0.08em;text-transform:uppercase;margin-top:0.15rem;">Consignado</div>
        </div>
        <div class="card-dark" style="padding:1rem 0.9rem;text-align:center;">
            <div style="font-family:'Outfit',sans-serif;font-size:1.3rem;font-weight:700;" class="gradient-text">{{ '$ ' . number_format($totalIntereses, 0, ',', '.') }}</div>
            <div style="font-size:0.6rem;color:var(--silver-dark);letter-spacing:0.08em;text-transform:uppercase;margin-top:0.15rem;">Intereses</div>
        </div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.6rem;padding:0 1.25rem 1rem;">
        <div class="card-dark" style="padding:0.85rem 0.9rem;text-align:center;">
            ...
            <div style="font-size:0.58rem;color:var(--silver-dark);letter-spacing:0.06em;text-transform:uppercase;margin-top:0.1rem;">Consign. hoy</div>
        </div>
        <div class="card-dark" style="padding:0.85rem 0.9rem;text-align:center;">
            <div style="font-family:'Outfit',sans-serif;font-size:1.1rem;font-weight:700;color:var(--silver-bright);">{{ $mesActual }}</div>
            <div style="font-size:0.58rem;color:var(--silver-dark);letter-spacing:0.06em;text-transform:uppercase;margin-top:0.1rem;">Consign. del mes</div>
        </div>
    </div>
